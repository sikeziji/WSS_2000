...
public class FragmentUtils {
     ...
     * @return fragment
     */
    public static Fragment addFragments(@NonNull FragmentManager fragmentManager, @NonNull List<Fragment> fragments, int showIndex, int containerId) {
     ...
     * @return fragment
     */
    public static Fragment popAddFragment(@NonNull FragmentManager fragmentManager, int containerId, @NonNull Fragment fragment, boolean isAddStack, SharedElement... sharedElement) {
        putArgs(fragment, new Args(containerId, false, isAddStack));
     ...
     * @return fragment
     */
    public static Fragment popAddFragment(@NonNull FragmentManager fragmentManager, int containerId, @NonNull Fragment fragment, boolean isAddStack) {
        putArgs(fragment, new Args(containerId, false, isAddStack));
...
//        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
    ...
    /**
     * 处理fragment回退<p>如果fragment实现了OnBackClickListener接口，返回{@code true}: 表示已消费回退键事件，反之则没消费</p>
    ...
    /**
     * 处理fragment回退键
     * * <p>如果fragment实现了OnBackClickListener接口，返回{@code true}: 表示已消费回退键事件，反之则没消费</p>     * <p>具体示例见FragmentActivity</p>     *
     * * @param fragmentManager fragment管理器
     * * @return 是否消费回退事件
     */
