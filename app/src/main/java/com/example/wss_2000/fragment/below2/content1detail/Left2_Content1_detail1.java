 ...
 * @Version: 1.0
 */
public class Left2_Content1_detail1 extends BaseFragment {

    private static Left2_Content1_detail1 fragment;

    public static Left2_Content1_detail1 newInstance() {
        Bundle args = new Bundle();
        if (fragment == null) {
            fragment = new Left2_Content1_detail1();
        }
    ...
    protected int getLayoutResId() {
        return R.layout.left2_content1_detail1;
    }
