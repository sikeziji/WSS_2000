 ...
 * @Version: 1.0
 */
public class Left5_Content2 extends BaseFragment {

    private static Left5_Content2 fragment;

    public static Left5_Content2 newInstance() {

        Bundle args = new Bundle();
        if (fragment == null) {
            fragment = new Left5_Content2();
        }
    ...
    protected int getLayoutResId() {
        return R.layout.left5fragment2;
    }
