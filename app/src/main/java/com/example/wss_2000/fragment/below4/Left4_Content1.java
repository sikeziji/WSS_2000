 ...
 * @Version: 1.0
 */
public class Left4_Content1 extends BaseFragment {

    private static Left4_Content1 fragment;

    public static Left4_Content1 newInstance() {
        Bundle args = new Bundle();
        if (fragment == null) {
            fragment = new Left4_Content1();
        }
    ...
    protected int getLayoutResId() {
        return R.layout.left4fragment1;
    }
